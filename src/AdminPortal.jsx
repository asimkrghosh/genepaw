...
const SIGNIFICANCE_OPTIONS = [
  "Informational — no immediate clinical action required. Monitor during routine check-ups.",
  "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.",
  "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.",
];
export const makeMarker = (name, gene, risk, species, significance, description) => ({ name, gene, risk, species, significance, description });
export const MARKER_CATEGORIES = [
  { id: "behaviour", name: "Behaviour", color: "#F59E0B", markers: [
    makeMarker("Arginine Vasopressin Receptor 1A", "AVPR1A (VT3R)", "Medium", "Homo sapiens, Microtus ochrogaster, Canis lupus familiaris, Mus musculus, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the vasopressin V1a receptor, a GPCR mediating the central effects of vasopressin/vasotocin on social behavior, pair bonding, aggression, and stress responses."),
    makeMarker("Dopamine Receptor D1", "DRD1", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the dopamine D1 receptor, the most abundant dopamine receptor in the brain. A stimulatory GPCR that activates adenylyl cyclase and mediates reward, motivation, and motor behavior."),
    makeMarker("Dopamine Receptor D2", "DRD2", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Rattus norvegicus, Gallus gallus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the dopamine D2 receptor, an inhibitory GPCR that reduces cAMP production. Exists as long (D2L) and short (D2S) splice variants with distinct functions in postsynaptic signaling and autorecept"),
    makeMarker("General Transcription Factor IIi", "GTF2I", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a multifunctional transcription factor involved in signal-induced gene expression. Located in the Williams-Beuren syndrome critical region."),
    makeMarker("GTF2I Repeat Domain Containing 1", "GTF2IRD1", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a transcription factor in the Williams-Beuren syndrome critical region that regulates craniofacial and muscular development and behavioral traits."),
    makeMarker("5-Hydroxytryptamine Receptor 1A", "HTR1A", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the serotonin 5-HT1A receptor, an inhibitory G protein-coupled receptor in the brain that modulates anxiety, mood, and behavioral responses."),
    makeMarker("5-Hydroxytryptamine Receptor 1B", "HTR1B", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the serotonin 5-HT1B receptor, a presynaptic autoreceptor that inhibits serotonin release and modulates aggression and impulsivity."),
    makeMarker("5-Hydroxytryptamine Receptor 2A", "HTR2A", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the serotonin 5-HT2A receptor, a Gq-coupled receptor mediating excitatory serotonergic signaling involved in mood, cognition, and perception."),
    makeMarker("Monoamine Oxidase B", "MAOB", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes monoamine oxidase B, a mitochondrial enzyme that catalyzes the oxidative deamination of biogenic and xenobiotic amines including dopamine and phenylethylamine."),
    makeMarker("Neuropeptide Y", "NPY", "Medium", "Homo sapiens, Mus musculus, Gallus gallus, Sus scrofa, Bos taurus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "A 36-amino acid neuropeptide widely distributed in the central and peripheral nervous system, regulating appetite, stress response, and anxiety. It is one of the most potent orexigenic factors in the "),
    makeMarker("Oxytocin/Neurophysin I Prepropeptide", "OXT", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Bos taurus, Ovis aries, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the precursor of oxytocin, a neuropeptide hormone critical for social bonding, parturition, lactation, and maternal behavior. Also functions as a neurotransmitter modulating trust and social c"),
    makeMarker("Oxytocin Receptor (Mesotocin Receptor in Birds)", "OXTR (Mesotocin receptor)", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Gallus gallus, Taeniopygia guttata, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the receptor for oxytocin (or mesotocin in birds), a G protein-coupled receptor mediating the behavioral and physiological effects of oxytocin signaling including pair bonding and social recog"),
    makeMarker("Serotonin Transporter (Solute Carrier Family 6 Member 4)", "SERT (SLC6A4)", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Macaca mulatta, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the serotonin transporter that mediates reuptake of serotonin from the synaptic cleft into presynaptic neurons. Primary target of SSRI antidepressants and central to serotonergic neurotransmis"),
    makeMarker("Solute Carrier Family 6 Member 3 (Dopamine Transporter, DAT)", "SLC6A3", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the dopamine transporter responsible for reuptake of dopamine from the synaptic cleft. Key regulator of dopaminergic neurotransmission and target of psychostimulants."),
    makeMarker("Tryptophan Hydroxylase 2", "TPH2", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the brain-specific isoform of tryptophan hydroxylase, the rate-limiting enzyme in serotonin biosynthesis in the central nervous system. Distinct from TPH1 which functions in peripheral tissues"),
    makeMarker("Williams-Beuren Syndrome Chromosome Region 17 (GALNT17)", "WBSCR17", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a polypeptide N-acetylgalactosaminyltransferase (GALNT17) located in the Williams-Beuren syndrome critical region. Involved in O-linked glycosylation of proteins."),
    makeMarker("Forkhead Box Protein P2", "FOXP2", "Medium", "Homo sapiens, Taeniopygia guttata (Zebra Finch), Mus musculus, Rattus norvegicus, Xenopus laevis, Xenopus tropicalis, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Transcription factor critical for speech and language development; regulates synaptic plasticity and motor learning circuits"),
    makeMarker("Monoamine Oxidase A", "MAOA", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Saccharomyces cerevisiae, Xenopus laevis, Xenopus tropicalis, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Mitochondrial enzyme that degrades serotonin, norepinephrine, and dopamine; key regulator of monoaminergic neurotransmission"),
    makeMarker("Solute Carrier Family 6 Member 4 (Serotonin Transporter)", "SLC6A4", "Medium", "Homo sapiens, Macaca mulatta (Rhesus Macaque), Mus musculus, Rattus norvegicus, Xenopus laevis, Danio rerio, Xenopus tropicalis, Caenorhabditis elegans, Drosophila melanogaster", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Serotonin reuptake transporter (5-HTT/SERT); primary mechanism for clearing serotonin from the synaptic cleft"),
    makeMarker("Dopamine Receptor D4", "DRD4", "Medium", "Homo sapiens, Parus major (Great Tit), Mus musculus, Rattus norvegicus, Xenopus tropicalis, Danio rerio, Xenopus laevis, Caenorhabditis elegans, Drosophila melanogaster", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "G protein-coupled receptor for dopamine; modulates attention, reward processing, and exploratory behaviour"),
    makeMarker("5-Hydroxytryptamine Receptor 2C", "HTR2C", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio, Xenopus tropicalis, Xenopus laevis, Caenorhabditis elegans, Drosophila melanogaster", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Serotonin receptor subtype involved in appetite regulation, anxiety, and impulsive behaviour"),
    makeMarker("Early Growth Response 1", "ZENK/EGR1", "Medium", "Taeniopygia guttata (Zebra Finch), Serinus canaria (Canary), Mus musculus, Rattus norvegicus, Xenopus tropicalis, Xenopus laevis, Drosophila melanogaster, Homo sapiens, Caenorhabditis elegans, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Immediate early gene (transcription factor) rapidly induced by neural activity; marker of song-driven neuronal activation in songbirds"),
    makeMarker("Adenylate Cyclase Activating Polypeptide 1 (PACAP)", "ADCYAP1", "Medium", "Sylvia atricapilla (Eurasian Blackcap), Junco hyemalis (Dark-eyed Junco), Danio rerio, Xenopus laevis, Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus tropicalis, Caenorhabditis elegans", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Neuropeptide involved in stress response, neural development, and migratory restlessness (Zugunruhe) in birds"),
    makeMarker("Vestigial Like Family Member 3", "VGLL3", "Medium", "Salmo salar (Atlantic Salmon), Xenopus laevis, Danio rerio, Drosophila melanogaster, Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Transcription co-factor influencing age at maturity in Atlantic salmon; large-effect locus for life history strategy (early vs. late maturity)"),
    makeMarker("Tyrosinase Related Protein 1", "TYRP1", "Medium", "Columba livia (Rock Pigeon), Ovis aries (Sheep), Mus musculus, Rattus norvegicus, Xenopus tropicalis, Caenorhabditis elegans, Danio rerio, Xenopus laevis, Homo sapiens", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Melanin biosynthesis enzyme also functioning as a pleiotropic gene affecting plumage color and behavioral traits in birds"),
  ]},
  { id: "cancer", name: "Cancer / Cell Cycle", color: "#EF4444", markers: [
    makeMarker("B-Raf Proto-Oncogene, Serine/Threonine Kinase", "BRAF", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Felis catus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a serine/threonine kinase in the RAS-MAPK signaling pathway that transduces growth signals from cell surface receptors to the nucleus. A key oncogene in multiple cancer types."),
    makeMarker("BRCA2 DNA Repair Associated", "BRCA2", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Felis catus, Gallus gallus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a key protein in homologous recombination DNA repair that interacts with RAD51 to facilitate repair of double-strand breaks. A critical tumor suppressor whose loss leads to genomic instability"),
    makeMarker("F-Box And WD Repeat Domain Containing 7", "FBXW7", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a substrate recognition component of the SCF ubiquitin ligase complex that targets oncoproteins like cyclin E, c-Myc, Notch, and mTOR for proteasomal degradation."),
    makeMarker("MutY DNA Glycosylase", "MUTYH", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a base excision repair enzyme that removes adenine mispaired with 8-oxoguanine, preventing G:C to T:A transversion mutations caused by oxidative DNA damage."),
    makeMarker("Platelet Derived Growth Factor Receptor Alpha", "PDGFRA", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Felis catus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a receptor tyrosine kinase that binds PDGF ligands and activates signaling cascades controlling cell proliferation, differentiation, and survival. Important in mesenchymal cell development."),
    makeMarker("Phosphatase and Tensin Homolog", "PTEN", "High", "Homo sapiens, Canis lupus familiaris, Felis catus, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a dual-specificity phosphatase that antagonizes PI3K/AKT signaling, functioning as a major tumor suppressor. Regulates cell growth, survival, and genomic stability."),
    makeMarker("Ribosomal Protein S15a", "RPS15A", "High", "Homo sapiens, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus, Saccharomyces cerevisiae", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a component of the 40S ribosomal subunit involved in translation initiation. Overexpression has been linked to cell proliferation and tumor progression."),
    makeMarker("THO Complex 1", "THOC1", "High", "Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a component of the THO/TREX complex involved in mRNA export from the nucleus to the cytoplasm. Also functions in transcription elongation and genome stability."),
    makeMarker("Tumor Protein P53", "TP53", "High", "Homo sapiens, Xenopus laevis, Xenopus tropicalis, Rattus norvegicus, Mus musculus, Danio rerio, Drosophila melanogaster, Caenorhabditis elegans, Saccharomyces cerevisiae", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Transcription factor and tumor suppressor ('guardian of the genome'); regulates cell cycle arrest, apoptosis, and DNA repair in response to genotoxic stress"),
    makeMarker("BRCA1 DNA Repair Associated", "BRCA1", "High", "Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus laevis, Xenopus tropicalis, Danio rerio, Caenorhabditis elegans, Saccharomyces cerevisiae", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "E3 ubiquitin ligase involved in homologous recombination DNA repair; maintains genomic stability and functions as a tumor suppressor"),
    makeMarker("MYC Proto-Oncogene, bHLH Transcription Factor", "MYC", "High", "Homo sapiens, Gallus gallus (Chicken, viral origin), Mus musculus, Rattus norvegicus, Danio rerio, Drosophila melanogaster, Xenopus tropicalis, Xenopus laevis, Caenorhabditis elegans", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Transcription factor regulating cell proliferation, growth, apoptosis, and metabolism; one of the most frequently deregulated oncogenes"),
    makeMarker("RB Transcriptional Corepressor 1", "RB1", "High", "Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus tropicalis, Drosophila melanogaster, Xenopus laevis, Caenorhabditis elegans, Danio rerio", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Tumor suppressor protein regulating G1/S cell cycle transition; binds and inhibits E2F transcription factors controlling S-phase gene expression"),
    makeMarker("KRAS Proto-Oncogene, GTPase", "KRAS", "High", "Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus laevis, Danio rerio, Drosophila melanogaster, Xenopus tropicalis, Caenorhabditis elegans", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Small GTPase acting as a molecular switch in RAS/MAPK signaling cascade; regulates cell growth, differentiation, and survival"),
  ]},
  { id: "cardiovascular", name: "Cardiovascular", color: "#DC2626", markers: [
    makeMarker("Apolipoprotein B", "APOB", "High", "Homo sapiens, Equus caballus, Mus musculus, Canis lupus familiaris, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes the primary structural protein of LDL and VLDL particles, essential for lipoprotein assembly, cholesterol transport, and receptor-mediated lipid uptake. Exists as two isoforms: apoB-100 (liver"),
    makeMarker("ATPase Plasma Membrane Ca2+ Transporting 1", "ATP2B1 (PMCA1)", "High", "Homo sapiens, Mus musculus, Gallus gallus, Rattus norvegicus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Saccharomyces cerevisiae", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes a ubiquitous plasma membrane calcium ATPase pump responsible for maintaining low intracellular calcium concentration. Essential for calcium homeostasis in all cell types including cardiomyocyt"),
    makeMarker("Calcium Voltage-Gated Channel Subunit Alpha1 C", "CACNA1C", "High", "Homo sapiens, Mus musculus, Rattus norvegicus, Canis lupus familiaris, Danio rerio", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes the pore-forming alpha-1C subunit of L-type voltage-gated calcium channels (Cav1.2). Critical for cardiac excitation-contraction coupling, vascular smooth muscle tone, and neuronal calcium sig"),
    makeMarker("Potassium Inwardly Rectifying Channel Subfamily J Member 2", "KCNJ2", "High", "Homo sapiens, Equus caballus, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes the Kir2.1 inward rectifier potassium channel, essential for maintaining resting membrane potential in cardiac, skeletal muscle, and neural cells."),
    makeMarker("Myosin Binding Protein C3, Cardiac", "MYBPC3", "High", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes cardiac myosin-binding protein C, a thick filament protein essential for cardiac sarcomere structure and contractile regulation."),
    makeMarker("Myosin Heavy Chain 7", "MYH7", "High", "Homo sapiens, Equus caballus, Mus musculus, Sus scrofa, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes beta-myosin heavy chain, the predominant myosin in cardiac ventricles and slow-twitch skeletal muscle fibers, essential for cardiac contraction."),
    makeMarker("Sodium Voltage-Gated Channel Alpha Subunit 5", "SCN5A", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes the alpha subunit of the cardiac voltage-gated sodium channel Nav1.5, responsible for the rapid upstroke of the cardiac action potential. Essential for normal cardiac conduction."),
    makeMarker("Striatin", "STRN", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes striatin, a calmodulin-binding scaffolding protein involved in cell signaling, endocytosis, and cell adhesion at the intercalated discs of cardiomyocytes."),
    makeMarker("Titin", "TTN", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Equus caballus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes titin, the largest known protein, spanning half the sarcomere from Z-disc to M-band in striated muscle. Functions as a molecular spring providing passive elasticity and serves as a scaffold fo"),
  ]},
  { id: "circadian", name: "Circadian Rhythm", color: "#8B5CF6", markers: [
    makeMarker("Aralkylamine N-Acetyltransferase", "AANAT", "Low", "Homo sapiens, Mus musculus, Ovis aries, Gallus gallus, Danio rerio, Rattus norvegicus", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Encodes the penultimate enzyme in melatonin biosynthesis, catalyzing the N-acetylation of serotonin to N-acetylserotonin. Critical for circadian regulation of melatonin production in the pineal gland."),
    makeMarker("Opsin 4 (Melanopsin)", "OPN4 (Melanopsin)", "Low", "Homo sapiens, Mus musculus, Gallus gallus, Columba livia, Danio rerio, Rattus norvegicus", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Encodes melanopsin, a photopigment expressed in intrinsically photosensitive retinal ganglion cells (ipRGCs) that mediates non-visual light responses including circadian photoentrainment and the pupil"),
    makeMarker("Clock Circadian Regulator", "CLOCK", "Low", "Homo sapiens, Mus musculus, Drosophila melanogaster (dClock), Rattus norvegicus, Rattus norvegicus, Xenopus tropicalis, Xenopus laevis, Danio rerio, Caenorhabditis elegans", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "bHLH-PAS transcription factor; core component of the molecular circadian clock; heterodimerizes with BMAL1 to drive circadian gene expression"),
    makeMarker("Period Circadian Regulator 2", "PER2", "Low", "Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus, Xenopus tropicalis, Xenopus laevis, Caenorhabditis elegans, Drosophila melanogaster", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Core circadian clock protein; negative regulator of CLOCK/BMAL1-mediated transcription; essential for ~24h oscillation of circadian rhythms"),
    makeMarker("Aryl Hydrocarbon Receptor Nuclear Translocator Like (Brain and Muscle ARNT-Like 1)", "ARNTL/BMAL1", "Low", "Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus tropicalis, Xenopus laevis, Danio rerio, Drosophila melanogaster, Caenorhabditis elegans", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Core circadian clock transcription factor; heterodimerizes with CLOCK to drive expression of Period and Cryptochrome genes"),
  ]},
  { id: "dermatology", name: "Dermatology", color: "#EC4899", markers: [
    makeMarker("Fermitin Family Member 1", "FERMT1", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes kindlin-1, a focal adhesion protein essential for integrin activation and keratinocyte adhesion to the basement membrane of the skin."),
    makeMarker("Keratin 71", "KRT71", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes keratin type II cytoskeletal 71, expressed in the inner root sheath of hair follicles and controlling hair texture and curl pattern."),
    makeMarker("Laminin Subunit Alpha 3", "LAMA3", "Medium", "Homo sapiens, Equus caballus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the alpha-3 chain of laminin-332 (formerly laminin-5), a major component of the basement membrane anchoring filaments in skin and mucous membranes."),
    makeMarker("Laminin Subunit Gamma 2", "LAMC2", "Medium", "Homo sapiens, Equus caballus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the gamma-2 chain of laminin-332, essential for epithelial cell adhesion to the basement membrane through hemidesmosomal anchoring."),
  ]},
  { id: "development", name: "Development", color: "#10B981", markers: [
    makeMarker("Cadherin 2 (N-Cadherin)", "CDH2", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Gallus gallus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes N-cadherin, a calcium-dependent cell adhesion molecule critical for neural crest migration, cardiac development, and synaptic structure. Essential for embryonic development and tissue morphoge"),
    makeMarker("Indian Hedgehog Signaling Molecule", "IHH", "Medium", "Homo sapiens, Equus caballus, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes Indian hedgehog, a signaling molecule critical for chondrocyte differentiation, bone formation, and endochondral ossification during skeletal development."),
    makeMarker("Limb And CNS Expressed 1", "LIX1", "Medium", "Homo sapiens, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a protein expressed during limb and central nervous system development, involved in gastrointestinal mesenchymal progenitor cell maintenance."),
    makeMarker("LLP Homolog, Long-Term Synaptic Facilitation Factor", "LLPH", "Medium", "Homo sapiens, Bos taurus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a protein implicated in long-term synaptic facilitation and chromatin remodeling, with roles in development and neuroplasticity."),
    makeMarker("Regulatory Factor X8", "RFX8", "Medium", "Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a member of the RFX transcription factor family involved in ciliogenesis and developmental gene regulation. RFX8 is less characterized than other RFX family members."),
    makeMarker("Semaphorin 3D", "SEMA3D", "Medium", "Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a secreted semaphorin that functions as a guidance cue for axons and migrating cells during development. Also involved in cardiovascular development and neural crest cell migration."),
    makeMarker("SPARC Like 1 (Hevin)", "SPARCL1", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes hevin, a matricellular glycoprotein that modulates cell adhesion and is involved in synaptogenesis. An anti-adhesive protein structurally related to SPARC/osteonectin."),
    makeMarker("Sonic Hedgehog Signaling Molecule", "SHH", "Medium", "Homo sapiens, Mus musculus, Gallus gallus (Chicken), Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus, Xenopus tropicalis, Saccharomyces cerevisiae, Xenopus laevis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Morphogen essential for embryonic patterning including neural tube, limb, and digit formation; ventral midline signaling"),
    makeMarker("Paired Box 6", "PAX6", "Medium", "Homo sapiens, Mus musculus, Drosophila melanogaster, Xenopus laevis, Danio rerio, Xenopus tropicalis, Caenorhabditis elegans, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Master control gene for eye development; transcription factor regulating lens, cornea, retina, and brain patterning"),
    makeMarker("Bone Morphogenetic Protein 4", "BMP4", "Medium", "Geospiza fortis (Medium Ground Finch), Geospiza magnirostris (Large Ground Finch), Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus tropicalis, Xenopus laevis, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "TGF-beta superfamily signaling molecule regulating bone, cartilage, and craniofacial morphogenesis"),
    makeMarker("Homeobox A13", "HOXA13", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus tropicalis, Danio rerio, Xenopus laevis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Transcription factor specifying distal limb and digit identity; regulates appendage patterning in vertebrates"),
    makeMarker("Wnt Family Member 3A", "WNT3A", "Medium", "Homo sapiens, Mus musculus, Xenopus laevis, Caenorhabditis elegans, Danio rerio, Mus musculus, Rattus norvegicus, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Secreted signaling molecule in the canonical Wnt pathway; essential for posterior body axis formation and somitogenesis"),
    makeMarker("Fibroblast Growth Factor 8", "FGF8", "Medium", "Homo sapiens, Mus musculus, Gallus gallus (Chicken), Rattus norvegicus, Xenopus tropicalis, Danio rerio, Xenopus laevis, Caenorhabditis elegans", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Signaling molecule critical for limb bud outgrowth, brain patterning (midbrain-hindbrain boundary), and craniofacial development"),
    makeMarker("Notch Receptor 1", "NOTCH1", "Medium", "Drosophila melanogaster, Homo sapiens, Mus musculus, Danio rerio, Caenorhabditis elegans, Xenopus laevis, Rattus norvegicus, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Transmembrane receptor mediating lateral inhibition during cell fate decisions; Notch signaling is fundamental to neurogenesis, somitogenesis, and angiogenesis"),
    makeMarker("Delta Like Canonical Notch Ligand 3", "DLL3", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Python molurus (Burmese Python), Xenopus laevis, Danio rerio, Xenopus tropicalis, Caenorhabditis elegans", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Notch pathway ligand involved in somite segmentation; essential for proper vertebral column patterning"),
    makeMarker("Paired Like Homeodomain 2", "PITX2", "Medium", "Homo sapiens, Mus musculus, Lottia gigantea (Owl Limpet), Lymnaea stagnalis (Pond Snail), Xenopus laevis, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus, Saccharomyces cerevisiae, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Transcription factor essential for left-right body asymmetry; specifies left-sided organ identity during embryogenesis"),
  ]},
  { id: "endocrine", name: "Endocrine", color: "#F97316", markers: [
    makeMarker("Calcium Sensing Receptor", "CASR", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Mus musculus, Bos taurus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the calcium-sensing receptor, a GPCR on parathyroid and renal cells that detects extracellular calcium levels and regulates PTH secretion and renal calcium reabsorption. Master regulator of ca"),
    makeMarker("Cytochrome P450 Family 27 Subfamily B Member 1", "CYP27B1", "Medium", "Homo sapiens, Mus musculus, Sus scrofa, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes 25-hydroxyvitamin D 1-alpha-hydroxylase, the mitochondrial enzyme that produces the active hormone 1,25-dihydroxyvitamin D3 (calcitriol) in the kidney. The rate-limiting step in vitamin D acti"),
    makeMarker("Cytochrome P450 Family 2 Subfamily R Member 1", "CYP2R1", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes vitamin D 25-hydroxylase, the major hepatic enzyme that converts vitamin D3 (cholecalciferol) to 25-hydroxyvitamin D3, the main circulating form of vitamin D used for clinical assessment."),
    makeMarker("Iodothyronine Deiodinase 2", "DIO2", "Medium", "Homo sapiens, Gallus gallus, Coturnix japonica, Mus musculus, Canis lupus familiaris, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes type 2 deiodinase, a selenoenzyme that converts the prohormone T4 (thyroxine) to the active thyroid hormone T3 (triiodothyronine) by outer ring deiodination. Critical for local thyroid hormone"),
    makeMarker("Fibroblast Growth Factor 23", "FGF23", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a bone-derived phosphaturic hormone that regulates phosphate homeostasis and vitamin D metabolism by acting on the kidney."),
    makeMarker("Growth Hormone 1", "GH", "Medium", "Homo sapiens, Bos taurus, Sus scrofa, Gallus gallus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes growth hormone (somatotropin), a pituitary peptide hormone that stimulates growth, cell reproduction, and IGF-1 production."),
    makeMarker("Insulin-Like Growth Factor 1", "IGF-1", "Medium", "Homo sapiens, Canis lupus familiaris, Bos taurus, Sus scrofa, Equus caballus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes insulin-like growth factor 1 (alternative notation). Same gene as IGF1; this notation is commonly used in veterinary and livestock genomics literature."),
    makeMarker("Insulin-Like Growth Factor 1", "IGF1", "Medium", "Homo sapiens, Canis lupus familiaris, Bos taurus, Sus scrofa, Mus musculus, Equus caballus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes insulin-like growth factor 1, a major mediator of growth hormone effects that promotes cell growth, differentiation, and survival through the IGF1R signaling pathway."),
    makeMarker("Insulin-Like Growth Factor 1 Receptor", "IGF1R", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Bos taurus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the IGF-1 receptor, a receptor tyrosine kinase that mediates IGF-1 and IGF-2 signaling to promote growth, proliferation, and survival."),
    makeMarker("Immunoglobulin Superfamily Member 1", "IGSF1", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a membrane glycoprotein of the immunoglobulin superfamily expressed in the pituitary and testis, involved in regulating thyroid-stimulating hormone and testosterone secretion."),
    makeMarker("Melanocortin 2 Receptor", "MC2R", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Bos taurus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the ACTH receptor (melanocortin-2 receptor), expressed primarily in the adrenal cortex where it mediates ACTH-stimulated cortisol production."),
    makeMarker("Nuclear Receptor Subfamily 3 Group C Member 2 (Mineralocorticoid Receptor)", "NR3C2 (MR)", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the mineralocorticoid receptor that binds aldosterone and cortisol, regulating sodium and potassium balance in the kidney. Also expressed in hippocampus where it modulates stress responses."),
    makeMarker("Proopiomelanocortin", "POMC", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Equus caballus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a polypeptide precursor that is cleaved into multiple bioactive peptides including ACTH, alpha-MSH, beta-endorphin, and beta-lipotropin. Central regulator of the stress response, appetite, and"),
    makeMarker("Parathyroid Hormone", "PTH", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes parathyroid hormone, the principal regulator of calcium and phosphorus homeostasis. PTH mobilizes calcium from bone, enhances renal calcium reabsorption, and stimulates renal 1,25-dihydroxyvit"),
    makeMarker("Vitamin D Receptor", "VDR", "Medium", "Homo sapiens, Gallus gallus, Bos taurus, Mus musculus, Canis lupus familiaris, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the nuclear receptor for 1,25-dihydroxyvitamin D3 (calcitriol), mediating the genomic actions of vitamin D on calcium homeostasis, bone metabolism, immune function, and cell differentiation."),
  ]},
  { id: "epigenetics", name: "Epigenetics", color: "#6366F1", markers: [
    makeMarker("Necdin", "NDN", "Low", "Homo sapiens, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus, Saccharomyces cerevisiae", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Encodes necdin, a maternally imprinted, paternally expressed gene in the Prader-Willi syndrome critical region that functions as a growth suppressor in postmitotic neurons."),
    makeMarker("DNA Methyltransferase 3 Alpha", "DNMT3A", "Low", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio, Xenopus tropicalis, Xenopus laevis", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "De novo DNA methyltransferase establishing new CpG methylation patterns during development; essential for genomic imprinting"),
    makeMarker("Tet Methylcytosine Dioxygenase 2", "TET2", "Low", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio, Xenopus tropicalis, Xenopus laevis, Drosophila melanogaster", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Enzyme catalyzing oxidation of 5-methylcytosine to 5-hydroxymethylcytosine; key mediator of active DNA demethylation"),
  ]},
  { id: "hematology", name: "Hematology", color: "#B91C1C", markers: [
    makeMarker("Ankyrin 1", "ANK1", "High", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes ankyrin-1, a structural protein that links the red blood cell membrane skeleton to integral membrane proteins (band 3, Rh complex). Essential for erythrocyte shape and deformability."),
    makeMarker("Solute Carrier Family 11 Member 2 (Divalent Metal Transporter 1)", "DMT1 (SLC11A2)", "High", "Homo sapiens, Mus musculus, Rattus norvegicus, Gallus gallus, Danio rerio", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes the primary intestinal iron transporter that mediates uptake of ferrous iron (Fe2+) from the gut lumen into enterocytes. Also transports iron from endosomes to cytoplasm after transferrin rece"),
    makeMarker("Coagulation Factor XII", "F12", "High", "Homo sapiens, Felis catus, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes Hageman factor, a serine protease involved in the initiation of the intrinsic coagulation pathway and the kallikrein-kinin system."),
    makeMarker("Coagulation Factor VIII", "F8", "High", "Homo sapiens, Canis lupus familiaris, Felis catus, Equus caballus, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes coagulation factor VIII, a cofactor for factor IXa in the intrinsic coagulation cascade. Deficiency causes hemophilia A."),
    makeMarker("Coagulation Factor IX", "F9", "High", "Homo sapiens, Canis lupus familiaris, Felis catus, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes coagulation factor IX (Christmas factor), a vitamin K-dependent serine protease essential for blood coagulation. Deficiency causes hemophilia B."),
    makeMarker("Pyruvate Kinase L/R", "PKLR", "High", "Homo sapiens, Canis lupus familiaris, Felis catus, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes the liver and red blood cell isoforms of pyruvate kinase, a glycolytic enzyme catalyzing the conversion of phosphoenolpyruvate to pyruvate. The R isoform is the sole glycolytic pathway in matu"),
    makeMarker("Solute Carrier Family 40 Member 1 (Ferroportin)", "SLC40A1", "High", "Homo sapiens, Mus musculus, Danio rerio, Canis lupus familiaris, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes ferroportin, the only known cellular iron exporter in mammals. Expressed on enterocytes, macrophages, and hepatocytes, it is essential for iron release into plasma and is regulated by hepcidin"),
    makeMarker("Solute Carrier Family 4 Member 1 (Band 3/Anion Exchanger 1)", "SLC4A1", "High", "Homo sapiens, Bos taurus, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes Band 3 protein, the major integral membrane protein of erythrocytes mediating chloride-bicarbonate exchange. Also important for CO2 transport and erythrocyte structural integrity."),
    makeMarker("Transferrin", "TF", "High", "Homo sapiens, Bos taurus, Equus caballus, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes serum transferrin, the primary iron transport protein in blood that binds ferric iron and delivers it to cells via transferrin receptor-mediated endocytosis. Essential for systemic iron distri"),
    makeMarker("Von Willebrand Factor", "VWF", "High", "Homo sapiens, Canis lupus familiaris, Sus scrofa, Mus musculus, Danio rerio, Rattus norvegicus", "Significant — predisposition detected. Recommend veterinary consultation and targeted screening.", "Encodes von Willebrand factor, a large multimeric glycoprotein essential for platelet adhesion to damaged endothelium and as a carrier protein for coagulation factor VIII in plasma."),
  ]},
  { id: "hepatic", name: "Hepatic", color: "#059669", markers: [
    makeMarker("ATPase Copper Transporting Beta", "ATP7B", "Medium", "Homo sapiens, Canis lupus familiaris, Rattus norvegicus, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Saccharomyces cerevisiae", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a copper-transporting ATPase expressed primarily in the liver that incorporates copper into ceruloplasmin and mediates biliary copper excretion. Essential for copper homeostasis."),
    makeMarker("Bile Acid-CoA:Amino Acid N-Acyltransferase", "BAAT", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the enzyme that conjugates bile acids with glycine or taurine in the liver, forming bile salts essential for fat digestion and absorption. Species differ in conjugation patterns."),
    makeMarker("Copper Metabolism Domain Containing 1", "COMMD1", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes COMMD1 (formerly MURR1), a protein that regulates copper homeostasis by promoting biliary copper excretion and interacting with ATP7B. Also involved in NF-kB signaling and sodium channel traff"),
    makeMarker("Cytochrome P450 Family 7 Subfamily A Member 1", "CYP7A1", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Felis catus, Canis lupus familiaris, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes cholesterol 7-alpha-hydroxylase, the rate-limiting enzyme in the classic bile acid synthesis pathway. Controls the conversion of cholesterol to bile acids in the liver."),
  ]},
  { id: "immune", name: "Immune System", color: "#3B82F6", markers: [
    makeMarker("BF/BL Region Class IV Gene 21 (Chicken MHC)", "BFIV21", "Medium", "Gallus gallus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "A gene within the chicken MHC (B locus) BF/BL region encoding a class IV lectin-like receptor. Part of the highly compact avian MHC that controls immune responses in poultry."),
    makeMarker("Blood Group Antigen BG1 (Chicken)", "BG1", "Medium", "Gallus gallus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a butyrophilin-like protein in the chicken MHC B locus blood group region. BG antigens are erythrocyte surface markers in poultry that serve as immunological markers linked to the MHC."),
    makeMarker("TNF Receptor Superfamily Member 4 (OX40/TNFRSF4)", "CD134", "Medium", "Homo sapiens, Felis catus, Mus musculus, Canis lupus familiaris, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes OX40 (CD134), a costimulatory receptor on activated T cells that promotes T cell survival, expansion, and cytokine production. Important in adaptive immune responses and immune regulation."),
    ...
    makeMarker("Cytotoxic T-Lymphocyte Associated Protein 4", "CTLA4", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Felis catus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a coinhibitory receptor on T cells that competes with CD28 for B7 ligand binding, delivering inhibitory signals that dampen T cell activation. A critical immune checkpoint molecule."),
    makeMarker("C-X-C Motif Chemokine Receptor 4", "CXCR4", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a chemokine receptor for CXCL12 (SDF-1) that plays essential roles in hematopoietic stem cell homing, immune cell trafficking, organogenesis, and angiogenesis. Also serves as a coreceptor for "),
    makeMarker("Dog Leukocyte Antigen Class I (DLA-88)", "DLA-88", "Medium", "Canis lupus familiaris, Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the major classical MHC class I molecule in dogs, responsible for presenting intracellular peptide antigens to CD8+ cytotoxic T cells. Highly polymorphic with over 50 known alleles."),
    makeMarker("Dog Leukocyte Antigen Class II DQ Beta 1", "DLA-DQB1", "Medium", "Canis lupus familiaris, Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the beta chain of the DLA-DQ class II MHC molecule in dogs, which presents extracellular peptide antigens to CD4+ helper T cells. Highly polymorphic and critical for immune response specificit"),
    makeMarker("Dog Leukocyte Antigen Class II DR Beta 1", "DLA-DRB1", "Medium", "Canis lupus familiaris, Canis lupus, Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the beta chain of the DLA-DR class II MHC molecule, the most polymorphic of the canine MHC class II genes. Central to adaptive immune responses and disease susceptibility in dogs."),
    makeMarker("Equine Leukocyte Antigen Class II DR Alpha", "ELA-DRA", "Medium", "Equus caballus, Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the alpha chain of the MHC class II DR molecule in horses, responsible for presenting extracellular peptide antigens to CD4+ T helper cells. Part of the equine MHC (ELA) complex."),
    makeMarker("Feline Leukocyte Antigen DRB", "FLA-DRB", "Medium", "Felis catus, Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the beta chain of the feline MHC class II DR molecule, critical for antigen presentation to CD4+ T helper cells in the adaptive immune response."),
    makeMarker("Feline Leukocyte Antigen E", "FLA-E", "Medium", "Felis catus, Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a non-classical MHC class I molecule in cats that presents peptides to NK cells via CD94/NKG2 receptors, regulating innate immune responses."),
    makeMarker("Forkhead Box N1", "FOXN1", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Felis catus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a transcription factor essential for thymic epithelial cell development and hair follicle differentiation. Loss of function causes the nude phenotype."),
    makeMarker("Interferon Alpha", "IFNA", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Bos taurus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes type I interferon alpha, a family of cytokines with antiviral, antiproliferative, and immunomodulatory properties secreted by leukocytes in response to viral infection."),
    makeMarker("Interleukin 1 Beta", "IL-1Î²", "Medium", "Homo sapiens, Canis lupus familiaris, Gallus gallus, Bos taurus, Felis catus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes interleukin-1 beta, a potent pro-inflammatory cytokine produced by activated macrophages that mediates fever, acute-phase responses, and inflammatory signaling."),
    makeMarker("Interleukin 6", "IL-6", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Bos taurus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Alternative notation for IL6. Encodes a central mediator of the acute-phase inflammatory response with roles in infection, autoimmunity, and metabolic regulation."),
    makeMarker("Interleukin 8 (CXCL8)", "IL-8", "Medium", "Homo sapiens, Bos taurus, Canis lupus familiaris, Equus caballus, Gallus gallus, Danio rerio, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes interleukin-8 (CXCL8), a CXC chemokine that is a potent chemoattractant for neutrophils and plays a central role in innate immune responses and inflammation."),
    makeMarker("Interleukin 12B", "IL12B", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Bos taurus, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the p40 subunit shared by IL-12 and IL-23, key cytokines that bridge innate and adaptive immunity by promoting Th1 cell differentiation and IFN-gamma production."),
    makeMarker("Interleukin 17A", "IL17A", "Medium", "Homo sapiens, Canis lupus familiaris, Bos taurus, Felis catus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes interleukin-17A, a pro-inflammatory cytokine produced by Th17 cells that plays a critical role in mucosal immunity, neutrophil recruitment, and defense against extracellular pathogens."),
    makeMarker("Interleukin 4 Receptor Subunit Alpha", "IL4RA", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the alpha chain of the IL-4 receptor, which also serves as a component of the IL-13 receptor. Critical for Th2 immune responses, IgE class switching, and allergic inflammation."),
    makeMarker("Interleukin 6", "IL6", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Bos taurus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes interleukin-6, a pleiotropic cytokine with both pro-inflammatory and anti-inflammatory properties, involved in acute-phase response, B-cell maturation, and fever induction."),
    makeMarker("Major Histocompatibility Complex", "MHC", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Bos taurus, Gallus gallus, Equus caballus, Danio rerio, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the major histocompatibility complex, a highly polymorphic gene region containing class I and class II genes essential for adaptive immunity and antigen presentation."),
    makeMarker("Protein Kinase, DNA-Activated, Catalytic Subunit", "PRKDC", "Medium", "Homo sapiens, Equus caballus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the catalytic subunit of DNA-dependent protein kinase (DNA-PKcs), essential for non-homologous end joining (NHEJ) DNA double-strand break repair and V(D)J recombination in immune cells."),
    makeMarker("Transferrin (Ovotransferrin/Conalbumin in Birds)", "TF (Ovotransferrin)", "Medium", "Gallus gallus, Meleagris gallopavo, Anas platyrhynchos, Danio rerio, Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes ovotransferrin (conalbumin) in birds, a multifunctional iron-binding glycoprotein found abundantly in egg white and serum. Functions in iron transport, innate immunity, and antimicrobial defen"),
    makeMarker("Toll-Like Receptor 3", "TLR3", "Medium", "Homo sapiens, Canis lupus familiaris, Equus caballus, Gallus gallus, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a pattern recognition receptor that detects double-stranded RNA from viruses, triggering innate immune responses via TRIF-dependent signaling and type I interferon production."),
    makeMarker("Toll-Like Receptor 7", "TLR7", "Medium", "Homo sapiens, Canis lupus familiaris, Gallus gallus, Mus musculus, Equus caballus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes an endosomal pattern recognition receptor that detects single-stranded RNA from viruses, activating MyD88-dependent signaling to produce type I interferons and proinflammatory cytokines."),
    makeMarker("Tumor Necrosis Factor", "TNF", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Bos taurus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes TNF-alpha, a pleiotropic proinflammatory cytokine produced primarily by macrophages. Central mediator of systemic inflammation, immune regulation, apoptosis, and cachexia."),
    makeMarker("Toll-Like Receptor 4", "TLR4", "Medium", "Homo sapiens, Mus musculus, Drosophila melanogaster (Toll), Danio rerio, Caenorhabditis elegans, Rattus norvegicus, Xenopus laevis, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Pattern recognition receptor detecting bacterial lipopolysaccharide (LPS); initiates innate immune response via NF-ÎºB signaling"),
    makeMarker("Major Histocompatibility Complex Class I B", "MHC-B", "Medium", "Gallus gallus (Chicken), Homo sapiens (HLA-B), Mus musculus (H-2), Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Cell surface glycoprotein presenting intracellular peptides to CD8+ T cells; central to adaptive immune recognition and transplant compatibility"),
    makeMarker("Interferon Gamma", "IFNG", "Medium", "Homo sapiens, Mus musculus, Danio rerio, Xenopus laevis, Xenopus tropicalis, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Pro-inflammatory cytokine produced by T cells and NK cells; activates macrophages and promotes Th1 immunity"),
    makeMarker("CRISPR Associated Protein 9", "CRISPR-CAS9", "Medium", "Streptococcus pyogenes, Streptococcus thermophilus, Escherichia coli, N/A", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Adaptive immune endonuclease in bacteria and archaea; provides sequence-specific defense against bacteriophages and plasmids"),
    makeMarker("Recombination Activating Gene 1", "RAG1", "Medium", "Homo sapiens, Mus musculus, Danio rerio (Zebrafish), Xenopus laevis, Rattus norvegicus, Saccharomyces cerevisiae, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Endonuclease essential for V(D)J recombination of immunoglobulin and T-cell receptor genes; generates antibody diversity"),
    makeMarker("MX Dynamin Like GTPase 1", "MX1", "Medium", "Gallus gallus (Chicken), Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus, Saccharomyces cerevisiae, Xenopus laevis, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Interferon-induced GTPase with antiviral activity against influenza and other RNA viruses; important in avian innate immunity"),
    makeMarker("Down Syndrome Cell Adhesion Molecule", "DSCAM", "Medium", "Drosophila melanogaster, Anopheles gambiae (Malaria Mosquito), Xenopus laevis, Xenopus tropicalis, Homo sapiens, Danio rerio, Mus musculus, Rattus norvegicus, Caenorhabditis elegans", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Cell adhesion molecule with extraordinary alternative splicing generating >38,000 isoforms in Drosophila; mediates self-recognition and immune defense in arthropods"),
  ]},
  { id: "longevity", name: "Longevity / Aging", color: "#A855F7", markers: [
    makeMarker("Reactive Oxygen Species Modulator 1", "ROMO1", "Low", "Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Encodes a mitochondrial membrane protein that modulates reactive oxygen species (ROS) production. Involved in mitochondrial morphology, cell proliferation, and redox signaling."),
    makeMarker("Telomerase Reverse Transcriptase", "TERT", "Low", "Homo sapiens, Mus musculus, Heterocephalus glaber (Naked Mole-Rat), Caenorhabditis elegans, Danio rerio, Rattus norvegicus, Saccharomyces cerevisiae, Xenopus laevis, Xenopus tropicalis", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Catalytic subunit of telomerase; maintains telomere length by adding TTAGGG repeats to chromosome ends; prevents replicative senescence"),
    makeMarker("Sirtuin 1", "SIRT1", "Low", "Homo sapiens, Mus musculus, Rattus norvegicus, Saccharomyces cerevisiae (Sir2), Xenopus laevis, Xenopus tropicalis, Caenorhabditis elegans (sir-2.1), Danio rerio, Drosophila melanogaster", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "NAD-dependent protein deacetylase regulating metabolism, stress resistance, and aging; key mediator of caloric restriction benefits"),
    makeMarker("Abnormal DAuer Formation 2 (Insulin/IGF-1 Receptor)", "DAF-2", "Low", "Caenorhabditis elegans, (IGF1R in Homo sapiens and Mus musculus), Danio rerio, Rattus norvegicus, Xenopus tropicalis, Drosophila melanogaster, N/A", "Informational — no immediate clinical action required. Monitor during routine check-ups.", "Insulin/IGF-1 receptor ortholog; master regulator of lifespan, dauer formation, and stress resistance in C. elegans"),
  ]},
  { id: "metabolism", name: "Metabolism", color: "#14B8A6", markers: [
    makeMarker("Acetyl-CoA Carboxylase Alpha", "ACACA (ACC)", "Medium", "Homo sapiens, Bos taurus, Gallus gallus, Mus musculus, Sus scrofa, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus, Saccharomyces cerevisiae", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the rate-limiting enzyme in de novo fatty acid synthesis, catalyzing the carboxylation of acetyl-CoA to malonyl-CoA. Plays a central role in lipogenesis regulation across species."),
    makeMarker("Aminocarboxymuconate Semialdehyde Decarboxylase", "ACMSD", "Medium", "Homo sapiens, Felis catus, Mus musculus, Rattus norvegicus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Saccharomyces cerevisiae", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes an enzyme in the tryptophan-kynurenine pathway that diverts tryptophan catabolism away from NAD+ synthesis toward complete oxidation. Regulates the balance between NAD+ biosynthesis and picoli"),
    makeMarker("Adiponectin, C1Q and Collagen Domain Containing", "ADIPOQ", "Medium", "Homo sapiens, Equus caballus, Felis catus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes adiponectin, a hormone secreted exclusively by adipocytes that enhances insulin sensitivity, promotes fatty acid oxidation, and has anti-inflammatory properties."),
    makeMarker("ALMS1 Centrosome and Basal Body Associated Protein", "ALMS1", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a large centrosomal protein involved in intracellular trafficking, ciliary function, and cell cycle regulation. Plays roles in energy homeostasis and metabolic regulation."),
    makeMarker("Argininosuccinate Synthase 1", "ASS1", "Medium", "Homo sapiens, Bos taurus, Mus musculus, Felis catus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes argininosuccinate synthase, the rate-limiting enzyme of the urea cycle that catalyzes the condensation of citrulline and aspartate to form argininosuccinate. Essential for nitrogen waste detox"),
    makeMarker("ATPase Copper Transporting Alpha", "ATP7A", "Medium", "Homo sapiens, Mus musculus, Canis lupus familiaris, Ovis aries, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus, Saccharomyces cerevisiae", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a copper-transporting P-type ATPase essential for copper absorption from the intestine and delivery to copper-dependent enzymes in the secretory pathway."),
    makeMarker("Agouti-Related Protein", "AgRP", "Medium", "Homo sapiens, Mus musculus, Gallus gallus, Rattus norvegicus, Sus scrofa, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a neuropeptide expressed in the hypothalamic arcuate nucleus that acts as an inverse agonist at melanocortin receptors MC3R/MC4R. A potent orexigenic factor that stimulates food intake and red"),
    makeMarker("Cystathionine Beta-Synthase", "CBS", "Medium", "Homo sapiens, Mus musculus, Felis catus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes cystathionine beta-synthase, a pyridoxal phosphate-dependent enzyme that catalyzes the first step in the transsulfuration pathway, converting homocysteine to cystathionine."),
    makeMarker("CD36 Molecule (Thrombospondin Receptor)", "CD36", "Medium", "Homo sapiens, Mus musculus, Bos taurus, Sus scrofa, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a scavenger receptor/fatty acid translocase on the cell surface that mediates uptake of long-chain fatty acids, oxidized LDL, and thrombospondin. Expressed in adipocytes, muscle, macrophages, "),
    makeMarker("Cysteine Dioxygenase Type 1", "CDO1", "Medium", "Homo sapiens, Felis catus, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes cysteine dioxygenase, the rate-limiting enzyme in cysteine catabolism that oxidizes cysteine to cysteine sulfinic acid. Regulates the balance between cysteine, taurine, and sulfate production."),
    makeMarker("CCAAT Enhancer Binding Protein Alpha", "CEBPA", "Medium", "Homo sapiens, Mus musculus, Gallus gallus, Sus scrofa, Bos taurus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes C/EBP-alpha, a leucine zipper transcription factor essential for adipocyte differentiation, hepatocyte function, and granulocyte development. A master regulator of adipogenesis."),
    makeMarker("Cytochrome c Oxidase Subunit I (Mitochondrial)", "COI", "Medium", "All metazoans (universal barcoding gene)", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the largest subunit of cytochrome c oxidase (Complex IV) in the mitochondrial genome. The terminal enzyme of the electron transport chain, catalyzing the transfer of electrons to molecular oxy"),
    makeMarker("Cysteine Sulfinic Acid Decarboxylase", "CSAD", "Medium", "Homo sapiens, Felis catus, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes cysteine sulfinic acid decarboxylase, the rate-limiting enzyme in the taurine biosynthesis pathway that decarboxylates cysteine sulfinic acid to hypotaurine."),
    makeMarker("ELOVL Fatty Acid Elongase 2", "ELOVL2", "Medium", "Homo sapiens, Felis catus, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a fatty acid elongase that catalyzes the elongation of C20 and C22 polyunsaturated fatty acids (PUFAs), particularly in the DHA (docosahexaenoic acid) biosynthesis pathway."),
    makeMarker("ELOVL Fatty Acid Elongase 5", "ELOVL5", "Medium", "Homo sapiens, Felis catus, Mus musculus, Canis lupus familiaris, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a fatty acid elongase that elongates C18-C20 polyunsaturated fatty acids, a critical step in the biosynthesis of arachidonic acid (AA) and eicosapentaenoic acid (EPA) from dietary precursors."),
    makeMarker("Fatty Acid Binding Protein 4", "FABP4 (A-FABP)", "Medium", "Homo sapiens, Bos taurus, Sus scrofa, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes adipocyte fatty acid binding protein, which binds long-chain fatty acids and is involved in lipid metabolism and adipocyte differentiation."),
    makeMarker("Fatty Acid Desaturase 1", "FADS1", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Bos taurus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes delta-5-desaturase, a rate-limiting enzyme in the biosynthesis of long-chain polyunsaturated fatty acids (LC-PUFAs) from essential fatty acid precursors."),
    ...
    makeMarker("Fatty Acid Synthase", "FASN", "Medium", "Homo sapiens, Bos taurus, Gallus gallus, Sus scrofa, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the central enzyme of de novo lipogenesis, catalyzing the synthesis of long-chain fatty acids from acetyl-CoA and malonyl-CoA precursors."),
    makeMarker("Fibroblast Growth Factor 21", "FGF21", "Medium", "Homo sapiens, Mus musculus, Felis catus, Bos taurus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a hepatokine that regulates glucose and lipid metabolism, energy homeostasis, and insulin sensitivity. Acts as a metabolic hormone with endocrine functions."),
    makeMarker("Ferritin Heavy Chain 1", "FTH1", "Medium", "Homo sapiens, Equus caballus, Canis lupus familiaris, Mus musculus, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the heavy subunit of ferritin with ferroxidase activity, essential for intracellular iron storage and protection against iron-mediated oxidative damage."),
    makeMarker("1,4-Alpha-Glucan Branching Enzyme 1", "GBE1", "Medium", "Homo sapiens, Felis catus, Equus caballus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes glycogen branching enzyme, essential for proper glycogen structure by creating branch points in the glycogen polymer."),
    makeMarker("GTP Cyclohydrolase 1", "GCH1", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the rate-limiting enzyme in tetrahydrobiopterin (BH4) biosynthesis, a cofactor required for nitric oxide synthesis and aromatic amino acid hydroxylases."),
    makeMarker("Glucokinase", "GCK", "Medium", "Homo sapiens, Felis catus, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes hexokinase IV (glucokinase), a glucose sensor in pancreatic beta cells and hepatocytes that plays a central role in glucose homeostasis and insulin secretion."),
    makeMarker("Glucokinase Regulator", "GCKR", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes glucokinase regulatory protein, which inhibits glucokinase activity in the liver and regulates hepatic glucose metabolism in response to fructose-6-phosphate."),
    makeMarker("Ghrelin And Obestatin Prepropeptide", "GHRL", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Bos taurus, Mus musculus, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the precursor of ghrelin (the 'hunger hormone') and obestatin. Ghrelin stimulates appetite, growth hormone release, and energy homeostasis."),
    makeMarker("Growth Hormone Secretagogue Receptor", "GHSR", "Medium", "Homo sapiens, Bos taurus, Sus scrofa, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the ghrelin receptor (GHS-R1a), a G protein-coupled receptor that mediates ghrelin signaling to regulate appetite, energy homeostasis, and growth hormone secretion."),
    makeMarker("Galactosidase Beta 1", "GLB1", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Ovis aries, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes beta-galactosidase, a lysosomal enzyme that cleaves terminal galactose residues from glycoconjugates. Deficiency causes GM1 gangliosidosis."),
    makeMarker("Glucagon-Like Peptide 1 Receptor", "GLP1R", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the receptor for GLP-1, an incretin hormone that stimulates insulin secretion, inhibits glucagon release, and promotes beta-cell survival."),
    makeMarker("Solute Carrier Family 2 Member 1", "GLUT1 (SLC2A1)", "Medium", "Homo sapiens, Mus musculus, Gallus gallus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes glucose transporter type 1, the principal glucose transporter at the blood-brain barrier and in erythrocytes, mediating facilitated glucose uptake."),
    makeMarker("Solute Carrier Family 2 Member 12", "GLUT12 (SLC2A12)", "Medium", "Homo sapiens, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes glucose transporter type 12, an insulin-responsive glucose transporter expressed in skeletal muscle, heart, and adipose tissue."),
    makeMarker("Solute Carrier Family 2 Member 2", "GLUT2 (SLC2A2)", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes glucose transporter type 2, a low-affinity, high-capacity transporter in hepatocytes, pancreatic beta cells, and intestinal epithelium. Functions as a glucose sensor."),
    makeMarker("Solute Carrier Family 2 Member 4", "GLUT4 (SLC2A4)", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Bos taurus, Sus scrofa, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the insulin-responsive glucose transporter in adipose tissue and skeletal muscle. Insulin stimulates GLUT4 translocation to the plasma membrane to facilitate glucose uptake."),
    makeMarker("Glucuronidase Beta", "GUSB", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes beta-glucuronidase, a lysosomal enzyme that degrades glycosaminoglycans. Deficiency causes mucopolysaccharidosis type VII (MPS VII, Sly syndrome)."),
    makeMarker("Glycogen Synthase 1", "GYS1", "Medium", "Homo sapiens, Equus caballus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the muscle isoform of glycogen synthase, the rate-limiting enzyme in glycogen biosynthesis in skeletal and cardiac muscle."),
    makeMarker("Hepcidin Antimicrobial Peptide", "HAMP", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Salmo salar, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes hepcidin, the master regulator of systemic iron homeostasis. Hepcidin inhibits ferroportin-mediated iron export from enterocytes, macrophages, and hepatocytes."),
    makeMarker("Alpha-L-Iduronidase", "IDUA", "Medium", "Homo sapiens, Felis catus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes alpha-L-iduronidase, a lysosomal enzyme required for degradation of heparan sulfate and dermatan sulfate glycosaminoglycans. Deficiency causes MPS I (Hurler/Scheie syndrome)."),
    makeMarker("Insulin Receptor", "INSR", "Medium", "Homo sapiens, Felis catus, Equus caballus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the insulin receptor, a receptor tyrosine kinase that mediates insulin signaling for glucose uptake, lipid metabolism, and cell growth."),
    makeMarker("Ketohexokinase", "KHK", "Medium", "Homo sapiens, Felis catus, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes ketohexokinase (fructokinase), the enzyme responsible for the first step of fructose metabolism, phosphorylating fructose to fructose-1-phosphate in the liver."),
    makeMarker("Leptin Receptor", "LEPR", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Bos taurus, Sus scrofa, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the receptor for leptin, a hormone produced by adipocytes that regulates energy balance, body weight, appetite, and neuroendocrine function through hypothalamic signaling."),
    makeMarker("Lipoprotein Lipase", "LPL", "Medium", "Homo sapiens, Felis catus, Bos taurus, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes lipoprotein lipase, a key enzyme in triglyceride metabolism that hydrolyzes triglycerides in circulating lipoproteins, releasing fatty acids for tissue uptake."),
    makeMarker("Metallothionein (family)", "MT", "Medium", "Homo sapiens, Ovis aries, Bos taurus, Equus caballus, Mus musculus, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Refers to the metallothionein gene family encoding small, cysteine-rich proteins that bind zinc, copper, and other heavy metals, providing metal homeostasis and detoxification."),
    makeMarker("NPC Intracellular Cholesterol Transporter 1", "NPC1", "Medium", "Homo sapiens, Mus musculus, Felis catus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Mediates intracellular cholesterol trafficking from late endosomes/lysosomes. Mutations cause Niemann-Pick type C disease, a fatal lysosomal storage disorder."),
    makeMarker("Nuclear Receptor Subfamily 4 Group A Member 3", "NR4A3", "Medium", "Homo sapiens, Mus musculus, Equus caballus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "An orphan nuclear receptor functioning as a transcription factor involved in energy metabolism, glucose homeostasis, and skeletal muscle adaptation to exercise."),
    makeMarker("N-Terminal Asparagine Amidase 1", "NTAN1", "Medium", "Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes an amidase that deamidates N-terminal asparagine residues as part of the N-end rule protein degradation pathway, converting asparagine to aspartate for ubiquitin-dependent proteolysis."),
    makeMarker("Ornithine Decarboxylase Antizyme 1", "OAZ1", "Medium", "Homo sapiens, Mus musculus, Gallus gallus, Sus scrofa, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a regulatory protein that inhibits ornithine decarboxylase (ODC), the rate-limiting enzyme in polyamine biosynthesis. OAZ1 expression is induced by polyamines via a programmed ribosomal frames"),
    makeMarker("Ornithine Transcarbamylase", "OTC", "Medium", "Homo sapiens, Mus musculus, Felis catus, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a mitochondrial matrix enzyme catalyzing the second step of the urea cycle, converting ornithine and carbamoyl phosphate to citrulline. Essential for nitrogen waste detoxification."),
  ...
  { id: "sensory", name: "Sensory", color: "#0EA5E9", markers: [
    ...
    makeMarker("Cone-Rod Homeobox", "CRX", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a paired-like homeodomain transcription factor essential for photoreceptor differentiation, outer segment morphogenesis, and maintenance of both rod and cone gene expression."),
    makeMarker("Cryptochrome 4", "CRY4", "Medium", "Erithacus rubecula, Gallus gallus, Columba livia, Danio rerio, Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes cryptochrome 4, a flavoprotein photoreceptor proposed to function as the magnetoreceptor sensor in migratory birds. Part of the cryptochrome family involved in light-dependent magnetic compass"),
    makeMarker("Congenital Stationary Night Blindness (associated genes)", "CSNB", "Medium", "Homo sapiens, Equus caballus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "CSNB refers to a group of inherited retinal disorders characterized by impaired night vision from birth due to defective signal transmission from photoreceptors to bipolar cells. Involves multiple gen"),
    makeMarker("Family With Sequence Similarity 174 Member A", "FAM174A", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a transmembrane protein of uncertain function that has been associated with hereditary hearing loss in dogs."),
    makeMarker("G Protein Subunit Alpha Transducin 3", "GNAT3", "Medium", "Homo sapiens, Felis catus, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes gustducin alpha-3, a G protein alpha subunit involved in taste signal transduction for sweet, bitter, and umami taste perception."),
    makeMarker("Olfactory Receptor Family 5 Subfamily A Member 1", "OR5A1", "Medium", "Homo sapiens, Mus musculus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes an olfactory receptor that detects beta-ionone, a key volatile compound in floral and fruit aromas. Part of the large G protein-coupled olfactory receptor gene family."),
    makeMarker("Progressive Rod-Cone Degeneration Protein", "PRCD", "Medium", "Canis lupus familiaris, Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a small protein localized to photoreceptor outer segment discs, essential for photoreceptor survival and maintenance. Its exact molecular function remains under investigation."),
    makeMarker("Retinoid Isomerohydrolase RPE65", "RPE65", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the retinal pigment epithelium isomerohydrolase that converts all-trans-retinyl esters to 11-cis-retinol, a critical step in the visual cycle that regenerates the visual chromophore."),
    makeMarker("Short Wavelength Sensitive Opsin 1 (UV/Violet Opsin)", "SWS1 (UV Opsin)", "Medium", "Gallus gallus, Taeniopygia guttata, Columba livia, Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the short-wavelength-sensitive cone opsin responsible for ultraviolet or violet light detection. In birds and some reptiles, SWS1 detects UV light; in most mammals it is shifted to violet sens"),
    makeMarker("Transient Receptor Potential Cation Channel Subfamily M Member 1 (Melastatin)", "TRPM1", "Medium", "Homo sapiens, Equus caballus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a calcium-permeable cation channel expressed in retinal ON-bipolar cells and melanocytes. Essential for the ON visual pathway that detects light increments."),
    makeMarker("Opsin 1, Long-Wave-Sensitive (Red)", "OPSIN1LW", "Medium", "Homo sapiens, Macaca fascicularis, Callithrix jacchus (Marmoset), Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Photopigment in retinal cone cells absorbing long-wavelength (red) light; enables trichromatic color vision"),
    makeMarker("Cryptochrome Circadian Regulator 1", "CRY1", "Medium", "Sylvia borin (Garden Warbler), Erithacus rubecula (European Robin), Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio, Xenopus laevis, Drosophila melanogaster, Saccharomyces cerevisiae, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Flavoprotein proposed to function as a magnetoreceptor in migratory birds; also core component of circadian clock"),
    makeMarker("Transient Receptor Potential Cation Channel Subfamily V Member 1", "TRPV1", "Medium", "Homo sapiens, Mus musculus, Desmodus rotundus (Vampire Bat), Caenorhabditis elegans, Drosophila melanogaster, Rattus norvegicus, Xenopus laevis, Xenopus tropicalis, Danio rerio, Saccharomyces cerevisiae", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Ion channel activated by capsaicin, heat (>43Â°C), and protons; nociceptor for thermal and chemical pain sensation"),
    makeMarker("Prestin (SLC26A5)", "PRESTIN", "Medium", "Homo sapiens, Mus musculus, Rhinolophus ferrumequinum (Horseshoe Bat), Tursiops truncatus (Dolphin), Xenopus tropicalis, Rattus norvegicus, Danio rerio, Caenorhabditis elegans, Xenopus laevis, Drosophila melanogaster", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Motor protein in outer hair cells of the cochlea; electromotile protein enabling mammalian hearing sensitivity and frequency selectivity"),
    makeMarker("Gustatory Receptor / Taste 2 Receptor family", "GR/TAS2R", "Medium", "Felis catus (Cat), Ailuropoda melanoleuca (Giant Panda), Homo sapiens, Mus musculus, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Bitter taste receptors; large gene family with species-specific expansions reflecting dietary adaptations"),
  ]},
  { id: "stress", name: "Stress Response", color: "#EA580C", markers: [
    makeMarker("Arginine Vasopressin Receptor 1B", "AVPR1B", "Medium", "Homo sapiens, Mus musculus, Canis lupus familiaris, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the vasopressin V1b receptor (also called V3), primarily expressed in anterior pituitary corticotrophs where it stimulates ACTH release. Modulates HPA axis activation and stress responses."),
    makeMarker("Corticotropin Releasing Hormone", "CRH", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Canis lupus familiaris, Equus caballus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes corticotropin-releasing hormone (CRF), the primary hypothalamic activator of the HPA stress axis. Released from the paraventricular nucleus to stimulate ACTH secretion from the anterior pituit"),
    makeMarker("Corticotropin Releasing Hormone Receptor 1", "CRHR1", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Canis lupus familiaris, Equus caballus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the primary CRH receptor mediating HPA axis activation and anxiety-like behavior. A GPCR expressed in the anterior pituitary, cerebral cortex, cerebellum, and amygdala."),
    makeMarker("Corticotropin Releasing Hormone Receptor 2", "CRHR2", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the type 2 CRH receptor, which mediates stress recovery, anxiolysis, and metabolic regulation. Binds CRH, urocortin II, and urocortin III with high affinity."),
    makeMarker("Dual Specificity Phosphatase 1", "DUSP1", "Medium", "Homo sapiens, Gallus gallus, Mus musculus, Rattus norvegicus, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes MAP kinase phosphatase 1 (MKP-1), an immediate early gene product that dephosphorylates and inactivates MAP kinases (ERK, JNK, p38). A key negative regulator of stress-activated signaling path"),
    makeMarker("FKBP Prolyl Isomerase 5", "FKBP5", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Macaca mulatta, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes an immunophilin co-chaperone that modulates glucocorticoid receptor sensitivity and is a key regulator of the stress hormone response system."),
    makeMarker("Glutathione Peroxidase (family)", "GPX", "Medium", "Homo sapiens, Bos taurus, Ovis aries, Equus caballus, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Refers to the glutathione peroxidase enzyme family that catalyzes the reduction of hydroperoxides by glutathione, protecting cells from oxidative damage."),
    makeMarker("Glutathione Peroxidase 1", "GPX1", "Medium", "Homo sapiens, Gallus gallus, Bos taurus, Sus scrofa, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the most abundant selenoprotein glutathione peroxidase, providing cytosolic antioxidant defense by reducing hydrogen peroxide and organic hydroperoxides."),
    makeMarker("Heat Shock Protein 70", "HSP70", "Medium", "Homo sapiens, Gallus gallus, Bos taurus, Sus scrofa, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus, Saccharomyces cerevisiae", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a major inducible heat shock protein that functions as a molecular chaperone, protecting cells from stress-induced protein denaturation and apoptosis."),
    makeMarker("Heat Shock Protein 90", "HSP90", "Medium", "Homo sapiens, Gallus gallus, Bos taurus, Mus musculus, Drosophila melanogaster, Caenorhabditis elegans, Danio rerio, Rattus norvegicus, Saccharomyces cerevisiae", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a molecular chaperone essential for the maturation of signaling proteins including steroid receptors, kinases, and transcription factors under both normal and stress conditions."),
    makeMarker("Heat Shock Protein Family B Member 1", "HSPB1", "Medium", "Homo sapiens, Equus caballus, Gallus gallus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes heat shock protein 27 (HSP27), a small heat shock protein with chaperone and anti-apoptotic activity that protects cells under stress conditions."),
    makeMarker("Nuclear Receptor Subfamily 3 Group C Member 1 (Glucocorticoid Receptor)", "NR3C1 (GR)", "Medium", "Homo sapiens, Mus musculus, Rattus norvegicus, Canis lupus familiaris, Danio rerio", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the glucocorticoid receptor, a ligand-activated transcription factor that mediates the effects of cortisol on gene expression. Central to the hypothalamic-pituitary-adrenal (HPA) axis feedback"),
    makeMarker("Superoxide Dismutase (General)", "SOD", "Medium", "Homo sapiens, Bos taurus, Gallus gallus, Mus musculus, Sus scrofa, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Refers to the superoxide dismutase enzyme family that catalyzes the dismutation of superoxide radicals into oxygen and hydrogen peroxide. First line of enzymatic antioxidant defense across all aerobic"),
    makeMarker("Superoxide Dismutase 1 (Cu/Zn-SOD)", "SOD1", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Equus caballus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes copper/zinc superoxide dismutase, a cytoplasmic enzyme that converts superoxide anions to hydrogen peroxide and oxygen. Major antioxidant defense enzyme in virtually all eukaryotic cells."),
    makeMarker("Superoxide Dismutase 2 (Mn-SOD)", "SOD2", "Medium", "Homo sapiens, Mus musculus, Bos taurus, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes manganese superoxide dismutase, localized to the mitochondrial matrix. Critical for protecting mitochondria from oxidative damage generated by the electron transport chain."),
    makeMarker("Thioredoxin Reductase 1", "TXNRD1", "Medium", "Homo sapiens, Mus musculus, Bos taurus, Gallus gallus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a selenoprotein that reduces thioredoxin using NADPH, maintaining cellular redox homeostasis. Part of the thioredoxin antioxidant system that protects against oxidative damage."),
  ]},
  { id: "structural", name: "Structural / Morphology", color: "#0EA5E9", markers: [
    makeMarker("Collagen Type XI Alpha 2 Chain", "COL11A2", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the alpha-2 chain of type XI collagen, a minor fibrillar collagen important for collagen fibril spacing in cartilage, the vitreous body, and the inner ear."),
    makeMarker("Collagen Type V Alpha 1 Chain", "COL5A1", "Medium", "Homo sapiens, Canis lupus familiaris, Felis catus, Equus caballus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes the alpha-1 chain of type V collagen, a regulatory fibrillar collagen that controls the initiation and diameter of type I collagen fibrils. Important for skin, tendon, and corneal structure."),
    makeMarker("Doublesex and Mab-3 Related Transcription Factor 3", "DMRT3", "Medium", "Equus caballus, Homo sapiens, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a transcription factor expressed in spinal cord interneurons that coordinate locomotor circuits. Critical for patterning spinal interneurons involved in limb coordination during locomotion."),
    makeMarker("Fibroblast Growth Factor 4", "FGF4", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a growth factor involved in limb development, embryogenesis, and cell proliferation. In dogs, a retrogene insertion causes chondrodysplasia."),
    makeMarker("High Mobility Group AT-Hook 2", "HMGA2", "Medium", "Homo sapiens, Canis lupus familiaris, Equus caballus, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a non-histone chromatin protein that modulates transcription by altering chromatin architecture. A major regulator of body size across species."),
    makeMarker("Ligand Dependent Nuclear Receptor Corepressor Like", "LCORL", "Medium", "Homo sapiens, Equus caballus, Bos taurus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a transcriptional corepressor strongly associated with body height and stature across multiple species. One of the most significant body size loci in domestic animals."),
    makeMarker("Lamin A/C", "LMNA", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes nuclear lamins A and C through alternative splicing, structural proteins of the nuclear lamina essential for nuclear integrity, chromatin organization, and gene regulation."),
    makeMarker("Methionine Sulfoxide Reductase B3", "MSRB3", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes an antioxidant enzyme that repairs oxidized methionine residues in proteins. Strongly associated with ear morphology and hearing in dogs."),
    makeMarker("Non-SMC Condensin I Complex Subunit G", "NCAPG", "Medium", "Homo sapiens, Equus caballus, Bos taurus, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes a subunit of the condensin I complex involved in chromosome condensation during mitosis. Strongly associated with body size in domestic animals."),
    makeMarker("Procollagen-Lysine, 2-Oxoglutarate 5-Dioxygenase 1", "PLOD1", "Medium", "Homo sapiens, Mus musculus, Felis catus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes lysyl hydroxylase 1, which catalyzes the hydroxylation of lysine residues in collagen-like peptides. Essential for collagen crosslinking and connective tissue integrity."),
    makeMarker("Peptidylprolyl Isomerase B (Cyclophilin B)", "PPIB", "Medium", "Homo sapiens, Canis lupus familiaris, Mus musculus, Danio rerio, Rattus norvegicus", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Encodes cyclophilin B, an endoplasmic reticulum-resident peptidyl-prolyl cis-trans isomerase that assists in collagen folding and is part of the collagen prolyl 3-hydroxylation complex."),
    makeMarker("Collagen Type I Alpha 1 Chain", "COL1A1", "Medium", "Homo sapiens, Mus musculus, Bos taurus (Cattle), Danio rerio, Xenopus laevis, Rattus norvegicus, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Major structural protein of bone, tendon, skin, and connective tissue; forms triple-helical collagen fibrils"),
    makeMarker("Paired Like Homeodomain 1", "PITX1", "Medium", "Gasterosteus aculeatus (Three-spined Stickleback), Homo sapiens, Mus musculus, Rattus norvegicus, Xenopus laevis, Xenopus tropicalis, Saccharomyces cerevisiae, Caenorhabditis elegans, Danio rerio, Drosophila melanogaster", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Transcription factor regulating hindlimb identity and pituitary development; key gene for limb reduction evolution"),
    makeMarker("RUNX Family Transcription Factor 2", "RUNX2", "Medium", "Homo sapiens, Canis lupus familiaris (Dog), Mus musculus, Drosophila melanogaster, Danio rerio, Xenopus laevis, Caenorhabditis elegans, Rattus norvegicus, Xenopus tropicalis", "Moderate — recommend carrier testing for breeding animals. Periodic screening advised.", "Master regulator of osteoblast differentiation; essential for bone formation and skeletal morphogenesis"),
  ]}
];
...
function MarkersAdmin() {
  ...
  const [confirmDelete, setConfirmDelete] = useState(null); // { catId, idx, name }

  useEffect(() => {
    fetch("/api/v1/markers/categories")
      .then((r) => r.json())
      .then((data) => {
        setCategories(transformApiCategories(data.items));
        setLoading(false);
      })
      .catch(() => {
        setCategories(MARKER_CATEGORIES.map((c) => ({ ...c, markers: [...c.markers] })));
        setLoading(false);
      });
  }, []);
